      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-10 shadow-xl border border-gray-100 dark:border-gray-700">
            <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
              <p>
                ...
                <span className="font-semibold text-gray-900 dark:text-white">Bandung</span>,
                a beautiful town in West Java
              </p>

              <p>
                Currently studying at{' '}
                <span className="font-semibold text-gray-900 dark:text-white">SMKN 1 Cipeundeuy</span>{' '}
                 in the Software Engineering (RPL) department. Throughout my studies, I’ve learned various aspects of programming, web development, database management, and API integration. I enjoy creating projects that solve real problems, I’m always excited to explore new technologies, improve my abilities, and continue growing in the world of software development.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-700 dark:to-gray-600 p-4 rounded-xl border border-blue-100 dark:border-gray-600">
                ...
                <p className="font-bold text-gray-900 dark:text-white">SMKN 1 Cipeundeuy</p>
              </div>
              <div className="bg-gradient-to-br from-teal-50 to-green-50 dark:from-gray-700 dark:to-gray-600 p-4 rounded-xl border border-teal-100 dark:border-gray-600">
                ...
                <p className="font-bold text-gray-900 dark:text-white">Bandung Barat</p>
              </div>
              <div className="bg-gradient-to-br from-pink-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 p-4 rounded-xl border border-pink-100 dark:border-gray-600">
                ...
                <p className="font-bold text-gray-900 dark:text-white">eginazmu</p>
              </div>
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 p-4 rounded-xl border border-gray-200 dark:border-gray-600">
                ...
                <p className="font-bold text-gray-900 dark:text-white">eginazmu1</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-600 rounded-3xl p-1 shadow-2xl">
              <div className="bg-gray-900 rounded-3xl overflow-hidden">
                <div className="aspect-square relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 text-center">
                    <p className="text-2xl font-bold text-white mb-1">Full Stack Developer</p>
                    <p className="text-lg text-gray-200">Passionate Coder</p>
                  </div>
                </div>
              </div>
            </div>
